...
# ---- Контури
SOBEL_KSIZE = 3
SOBEL_THRESH_SCALE = 0.55

ROBERTS_THRESH_SCALE = 0.60
PREWITT_THRESH_SCALE = 0.55
SCHARR_THRESH_SCALE = 0.50
...
# ---- Хребти
RIDGE_SIGMA = 1.2
RIDGE_THRESH_REL = 0.25

# Hessian Ridge НЕ змінювався
FRANGI_BETA = 0.5
FRANGI_C = 0.5
FRANGI_THRESH_REL = 0.08

SATO_ALPHA = 0.5
SATO_GAMMA = 0.5
SATO_THRESH_REL = 0.08

RIDGE_SIGMAS = [1.0, 1.6, 2.2, 3.0]
...
GROUPS = [
    {
        ...
        "methods": [
            ("Sobel", sobel_method),
            ("Roberts", roberts_method),
            ("Prewitt", prewitt_method),
            ("Scharr", scharr_method),
        ],
    },
    {
        "group_name": "Кути",
    ...
    },
    {
        ...
        "methods": [
            ("LoG", log_blob_method),
            ("DoG", dog_blob_method),
            ("Hessian Blob", hessian_blob_method),
        ],
    },
    {
        "group_name": "Хребти",
        "methods": [
            ("Hessian Ridge", hessian_ridge_method),
            ("Frangi-like", frangi_like_method),
            ("Sato-like", sato_like_method),
        ],
    },
]
